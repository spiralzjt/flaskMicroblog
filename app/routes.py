...
def index():
    ...
    if form.validate_on_submit():
        ...
        # standard practice to respond to a POST request generated by a web form submission with a redirect
        # if a POST request is answered with a redirect, the browser is now instructed to send a GET request to grab the page indicated in the redirect,
...
def explore():
    ...
    # paginate() returns an object of Pagination class from Flask-SQLAlchemy
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        # whether the user exists or not, will flash the info so that user cannot use this form to figure out if a given user is a member or not
